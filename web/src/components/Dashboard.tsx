...
export default function Dashboard() {
  ...
  const chemistryProgress = calculateSubjectProgress('chemistry', completed, profile?.studentClass);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <section className="lg:col-span-2 p-8 bg-white rounded-[3rem] border border-slate-100 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <ProgressItem label="Physics" progress={physicsProgress} color="bg-sky-500" />
            <ProgressItem label="Chemistry" progress={chemistryProgress} color="bg-rose-500" />
            <ProgressItem label="Biology" progress={biologyProgress} color="bg-teal-500" />
            <ProgressItem label="History & Civics" progress={historyProgress} color="bg-amber-500" />
            <ProgressItem label="Geography & Economics" progress={geographyProgress} color="bg-emerald-500" />
          </div>
        </section>
