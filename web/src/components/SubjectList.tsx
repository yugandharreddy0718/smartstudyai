...
const SUBJECTS = [
  { id: 'maths', name: 'Mathematics', icon: '📐', color: 'bg-indigo-500', count: 14 },
  { id: 'physics', name: 'Physics', icon: '⚡', color: 'bg-sky-500', count: 4 },
  { id: 'chemistry', name: 'Chemistry', icon: '🧪', color: 'bg-rose-500', count: 4 },
  { id: 'biology', name: 'Biology', icon: '🌿', color: 'bg-teal-500', count: 4 },
  { id: 'history', name: 'History & Civics', icon: '📜', color: 'bg-amber-500', count: 7 },
  { id: 'geography', name: 'Geography & Economics', icon: '🌍', color: 'bg-emerald-500', count: 7 },
];
